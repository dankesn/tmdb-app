export class MovieDetails {
    ...
    this.production_companies = obj && obj.production_companies || [];
    this.production_countries = obj && obj.production_countries || [];
    this.release_date = obj && obj.release_date || null;
    this.revenue = obj && obj.revenue || null;
    this.runtime = obj &&  obj.runtime || [];
    this.spoken_languages = obj && obj.spoken_languages || [];
